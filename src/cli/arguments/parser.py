...
DEFAULT_PARSER.add_argument("--dict-size",
	action="store",
	metavar="percent",
	help="""percentage, expressed as a floating number 0. < percent <= 1., to choose just the top percentage of words in the learning dictionary. Rest of the words will be ignored. If equals 1., no word will be omitted. Default is %.2f"""%(DICT_SIZE_DEFAULT),
	type=float,
