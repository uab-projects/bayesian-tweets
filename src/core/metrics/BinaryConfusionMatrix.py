...
class BinaryConfusionMatrix(ConfusionMatrix):
	...
	def addClassification(self, real, predicted):
		"""
		Adds a classification to the confusion matrix, specifying the real
		classification and the predicted classification and will add one item to
		the matching cell in the matrix depending if it's a TP, FN, FT, TN
